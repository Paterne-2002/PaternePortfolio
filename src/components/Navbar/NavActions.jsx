...
export default function NavActions() {
  ...
  return (
    <div className="navbar__actions">
      <a href="https://github.com/Paterne-2002" target="_blank" rel="noreferrer"
        className="navbar__icon-link" aria-label="GitHub">
        <GitHubIcon />
      </a>
      <a href="https://www.facebook.com/fanilonirina.kanto.paterne/" target="_blank" rel="noreferrer"
        className="navbar__icon-link" aria-label="Facebook">
        <FacebookIcon />
      </a>
    </div>
  );
